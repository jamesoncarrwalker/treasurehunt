...
--
-- Host: localhost
-- Generation Time: Jun 07, 2019 at 03:58 AM
...
CREATE TABLE `games` (
  ...
  `cols` int(100) NOT NULL,
  `treasurePosition` text NOT NULL
...
CREATE TABLE `userProgress` (
  ...
  `guesses` int(10) NOT NULL,
  `clues` int(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `users` (
  ...
  `last_failed_login` int(11) NOT NULL,
